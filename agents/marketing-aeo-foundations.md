...
description: AEO infrastructure — llms.txt, AI-aware robots.txt, token-budgeted content, structured Markdown, agent discovery for AI crawlers/citation engines.
color: "#059669"
emoji: 🏗️
