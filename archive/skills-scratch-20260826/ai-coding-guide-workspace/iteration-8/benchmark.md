...
| Expectation | Result | Evidence |
|-------------|--------|----------|
| output_contains.all: missing [路由指南维护] | ❌ | output does not contain required keywords: [路由指南维护] |
...
| Expectation | Result | Evidence |
|-------------|--------|----------|
| output_contains.all: missing [gitnexus] | ❌ | output does not contain required keywords: [gitnexus] |
...
| Expectation | Result | Evidence |
|-------------|--------|----------|
| output_contains.all: missing [口令] | ❌ | output does not contain required keywords: [口令] |
