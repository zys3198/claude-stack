...
3. REQUIREMENT 执行 `prepare --emit-prompt → start`，由主 Agent 按 [references/clarify-requirements.md](../../references/clarify-requirements.md) 完成澄清并填写需求报告，再 `finish`；禁止启动需求分析 subagent。
